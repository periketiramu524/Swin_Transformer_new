                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => setSelectedTaxonomy(finding.label)}>
                      <div 
                        ...
                        style={{ backgroundColor: finding.palette.lightBg, borderBottom: "40px solid " + finding.palette.lightBg, color: finding.palette.textColor }}
                      >
            ...
            >
              <div className="w-40 sm:w-44 shrink-0 flex items-center gap-2.5">
                <div 
                  ...
                  style={{ backgroundColor: item.activeIndicatorColor, borderBottom: "16px solid " + item.activeIndicatorColor }}
                />
